...
const SimpleExperiences = ({experience}) => {
  return (
    <div className='md:h-[350px] md:w-[240px] sm:w-full border-2 border-dashed rounded-2xl mt-12 p-4'>
...
export default SimpleExperiences
